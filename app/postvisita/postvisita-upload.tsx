...
function esColumnaCliente(value: unknown) {
  ...
  return ["ndecliente", "numerodecliente", "nrodecliente", "numdecliente", "numerocliente", "nrocliente", "numcliente", "suscriptor", "numerosuscriptor", "nrosuscriptor", "numsuscriptor", "idsuscriptor", "subscriber", "subscriberid"].includes(texto);
}
...
async function leerFilas(file: File): Promise<unknown[][]> {
  ...
  return XLSX.utils.sheet_to_json(workbook.Sheets[primeraHoja], { header: 1, defval: "", raw: true });
}
